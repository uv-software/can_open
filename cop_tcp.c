...
void cop_tcp_syntax(FILE *stream)
{
	...
	fprintf(stream, "\n");
	fprintf(stream, "<stop-node-request>  ::= \'[\'<sequence>\']\' [[<net>] <node>] \"start\"\n");
	fprintf(stream, "\n");
	...
	fprintf(stream, "\n");
	fprintf(stream, "5.1 Initialize gate way command\n");
	fprintf(stream, "\n");
	...
	fprintf(stream, "\n");
	fprintf(stream, "5.3 Retore configuration command\n");
	fprintf(stream, "\n");
	...
	fprintf(stream, "\n");
	fprintf(stream, "<get-version-response> ::= \'[\'<sequence>\']\' <vendor-id> <product-code> <revison-number> <serial-number> <gatyway-class> <protocol-version> <implementation-class> |\n");
	fprintf(stream, "                           \'[\'<sequence>\']\' \"Error:\" <error-code>\n");
	fprintf(stream, "\n");
	fprintf(stream, "7. Vendor-specific commands\n");
	fprintf(stream, "\n");
	fprintf(stream, "7.1 Get information command\n");
	fprintf(stream, "\n");
	...
	fprintf(stream, "                               \'[\'<sequence>\']\' \"Error:\" <error-code>\n");
	fprintf(stream, "\n");
	fprintf(stream, "7.2 Send CAN message command\n");
	fprintf(stream, "\n");
	...
	fprintf(stream, "                            \'[\'<sequence>\']\' \"Error:\" <error-code>\n");
	fprintf(stream, "\n");
	fprintf(stream, "7.3 Request CAN message command\n");
	fprintf(stream, "\n");
	fprintf(stream, "<remote-message-request>  ::= \'[\'<sequence>\']\' [<net>] \"send\" <cob-id> \"rtr\"\n");
	fprintf(stream, "\n");
	fprintf(stream, "<remote-message-response> ::= \'[\'<sequence>\']\' <length> {<value>}* |\n");
	fprintf(stream, "                              \'[\'<sequence>\']\' \"Error:\" <error-code>\n");
	fprintf(stream, "\n");
	fprintf(stream, "7.4 Read CAN message queue command\n");
	fprintf(stream, "\n");
	...
	fprintf(stream, "                            \'[\'<sequence>\']\' \"Error:\" <error-code>\n");
	fprintf(stream, "\n");
	fprintf(stream, "7.5 Wait command\n");
	fprintf(stream, "\n");
	...
	fprintf(stream, "\n");
	fprintf(stream, "8.1 Supported datatypes\n");
	fprintf(stream, "\n");
